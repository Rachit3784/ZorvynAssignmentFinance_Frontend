            ...
            <div className="glass-panel max-w-md w-full p-8 rounded-2xl shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button 
                        disabled={loading}
                        type="submit"
                        className="w-full bg-brand-600 hover:bg-brand-500 text-white font-medium py-3 rounded-xl transition-all shadow-lg shadow-brand-500/25 flex justify-center items-center"
                    >
                        {loading ? (
                ...
                <p className="text-center text-gray-400 mt-6 pt-6 border-t border-dark-800">
                    ...
                    <Link to="/signup" className="text-brand-500 hover:text-brand-400 font-medium">
                        Sign up
                    </Link>
                </p>
            </div>
